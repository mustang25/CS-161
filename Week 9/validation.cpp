 ...
 ** Author: Rob Navarro
 ** Date: May 30, 2015
 ** Description: A program with functions to determine if a number is a
 ** float or int
 *********************************************************************/
...
bool stringIsInt (string testString1) {
    ...
    //finding the last number location in the string
...
bool stringIsFloat (string testString2) {
    ...
    //finding the last +, -, ., or number in the string and storing it for testing.
